...
public class dumbMapPractice {
    ...
    //Regular Motors
    public DcMotor bird,leftFront,leftBack,rightFront,rightBack;
    public DcMotor slide1, slide2, slide3;

    //Regular Servos
    public Servo thingie;
    ...
    public dumbMapPractice(OpMode opMode) {
        this.opMode = opMode;
    }

    public dumbMapPractice(LinearOpMode opMode) {this.opMode = opMode;}
    ...
    public void init2() {
        thingie = this.opMode.hardwareMap.get(Servo.class, "dog" ); // 0.27 (close) 0.5 (open)
