...
@Autonomous(name = "ASpecBlue")
public class specauton3 extends OpMode {
...
//    private final Pose pCon2 = new Pose(76.2, 26.5, Math.toRadians(0));
    ...
    private final Pose wallGrab = new Pose(11.75, 23, Math.toRadians(0));


    private final Pose wallGrab2 = new Pose(12, 23, Math.toRadians(0));
    ...
    public void Lime(){
        ...
        switch (lowState) {
            ...
            case "limeRevCheck":
                ...
                if (mode == 2 && (lowHue < 230 && lowHue > 210)) {
