...
@TeleOp(name = "servotester (HT test)", group = "test")
public class servotesterdouble2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        servo6= hardwareMap.get(Servo.class, "highTurn" );
        servo7= hardwareMap.get(Servo.class, "highTurn2" );

        servo7.setDirection(Servo.Direction.REVERSE);


        servo6.setPosition(0.12);
        servo7.setPosition(0.12);
